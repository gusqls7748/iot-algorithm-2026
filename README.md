...
2. 선형 검색 : [소스](./basic/algorithm02/algorithm02/app01/app01.c)
    - 배열의 모든 요소를 순차적으로 검색
    - 찾는 요소가 있으면 그 위치에서 빠져나감
    - 찾는 요소가 없으면 배열의 마지막까지 비교 - 단점

3. 이진 검색 : [소스](./basic/algorithm02/algorithm02/app02/app02.c)
...
1. 스택 : [소스](./basic/algorithm02/algorithm02/app03/app03.c)
    - 접시를 싸는 구조와 동일한 자료구죠
    - 맨 처음에 쌓인 접시는 위의 쌓여있던 접시가 모두 제거되어야 꺼낼 수 있음
    - LIFO(Last In First Out) - 후입선출(가장 나중에 들어온 데이터가 가장 먼저 사용됨)

2. 스택 용어 : [소스](./basic/algorithm02/algorithm02/app03/IntStack.h)
    - push : 스택에 데이터 삽입 작업
    - pop : 스택에서 데이터 꺼내는 작업
