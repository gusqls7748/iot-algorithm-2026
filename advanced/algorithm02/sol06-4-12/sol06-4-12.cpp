// sol06-4-12.cpp : 이 파일에는 'main' 함수가 포함됩니다. 거기서 프로그램 실행이 시작되고 종료됩니다.
//
...
int main()
{
    ...
    vector<int> cases = { 1,2,3,2,3 };
    auto result1 = solution(cases);
    for (int num : result1) {
        cout << num << ", ";
    }
    cout << endl;
    ...
    vector<int> cases3 = { 1,6,9,5, 3, 2, 7 };
